...
#pragma mark - Utility Functions
  ...
  */
  ...
  static void error(string message, bool fatal = false){
    ...
    //printf("Tonic::error: %s\n", message.c_str() ); original comment out and include <stdio.h>
    cout << "Tonic::error: " << message.c_str() << endl;
    if (fatal){
  ...
  static void warning(string message){
    ...
    cout << "Tonic::warning: " << message.c_str() << endl;
  }

  static void debug(string message){
#ifdef TONIC_DEBUG
    //printf("Tonic::debug: %s\n", message.c_str());
    cout << "Tonic::debug " <<  message.c_str() << endl;
#endif
  }
